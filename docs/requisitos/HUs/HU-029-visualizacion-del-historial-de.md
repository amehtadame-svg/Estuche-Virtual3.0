<!--
  ¿Qué? Historia de usuario que describe la consulta del historial de precios de un producto.
  ¿Para qué? Formalizar el registro de cada cambio de precio realizado sobre un artículo.
  ¿Impacto? Permite auditar variaciones de precio y analizar tendencias comerciales.
-->
