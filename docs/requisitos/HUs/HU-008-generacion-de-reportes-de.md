<!--
  ¿Qué? Historia de usuario que describe la generación de reportes del desempeño de ventas.
  ¿Para qué? Formalizar la consolidación de la información comercial en periodos definidos.
  ¿Impacto? Sustenta la toma de decisiones gerenciales sobre el negocio.
-->
