<!--
  ¿Qué? Historia de usuario que describe la identificación de los productos más vendidos.
  ¿Para qué? Formalizar el análisis de rotación de inventario por volumen de ventas.
  ¿Impacto? Orienta las decisiones de compra y de exhibición de productos.
-->
