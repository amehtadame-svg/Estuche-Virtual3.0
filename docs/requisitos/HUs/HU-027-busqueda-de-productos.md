<!--
  ¿Qué? Historia de usuario que describe la búsqueda de productos dentro del catálogo.
  ¿Para qué? Formalizar la localización rápida de artículos por nombre, código o categoría.
  ¿Impacto? Agiliza tanto la operación interna como la experiencia de compra del cliente.
-->
