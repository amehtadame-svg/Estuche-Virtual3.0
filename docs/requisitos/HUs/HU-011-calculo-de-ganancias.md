<!--
  ¿Qué? Historia de usuario que describe el cálculo automático de utilidades del negocio.
  ¿Para qué? Formalizar la obtención de la ganancia neta a partir de costos y precios de venta.
  ¿Impacto? Permite conocer la rentabilidad real de la operación comercial.
-->
