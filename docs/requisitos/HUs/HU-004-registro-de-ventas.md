<!--
  ¿Qué? Historia de usuario que describe el registro de una venta en el punto de venta (POS).
  ¿Para qué? Formalizar el cobro y la salida de mercancía asociada a una transacción comercial.
  ¿Impacto? Es el proceso que genera el ingreso económico principal del negocio.
-->
