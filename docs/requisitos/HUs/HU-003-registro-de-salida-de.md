<!--
  ¿Qué? Historia de usuario que describe la salida manual de productos del almacén por motivos distintos a la venta.
  ¿Para qué? Formalizar los descuentos de stock por traslados, muestras o consumo interno, dejando trazabilidad.
  ¿Impacto? Evita descuadres entre el inventario físico y el registrado en el sistema.
-->
