<!--
  ¿Qué? Historia de usuario que describe la asignación y actualización de precios de productos.
  ¿Para qué? Formalizar el establecimiento del precio de venta al público de cada artículo.
  ¿Impacto? Define directamente el margen de ganancia del negocio.
-->
