<!--
  ¿Qué? Historia de usuario que describe el control de usuarios y sus permisos dentro del sistema.
  ¿Para qué? Formalizar la administración de cuentas internas y sus niveles de acceso.
  ¿Impacto? Protege la información sensible del sistema mediante control de acceso por rol.
-->
