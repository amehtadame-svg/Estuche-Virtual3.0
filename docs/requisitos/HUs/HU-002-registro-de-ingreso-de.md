<!--
  ¿Qué? Historia de usuario que describe el ingreso de mercancía nueva al almacén.
  ¿Para qué? Formalizar el incremento controlado y auditable del stock disponible.
  ¿Impacto? Sin este registro el stock quedaría desactualizado frente a la mercancía físicamente recibida.
-->
