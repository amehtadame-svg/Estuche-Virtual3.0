<!--
  ¿Qué? Historia de usuario que describe la venta de combos escolares en el punto de venta.
  ¿Para qué? Formalizar el descuento simultáneo del stock de todos los productos que integran un combo.
  ¿Impacto? Garantiza que la venta de paquetes no desincronice el inventario individual de cada producto.
-->
