<!--
  ¿Qué? Historia de usuario que describe el registro de combos o kits escolares.
  ¿Para qué? Formalizar la creación de agrupaciones de productos vendidas como una sola unidad comercial.
  ¿Impacto? Facilita la venta de paquetes escolares completos, un producto clave del negocio.
-->
