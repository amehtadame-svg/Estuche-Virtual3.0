<!--
  ¿Qué? Historia de usuario que describe la eliminación o inactivación de productos.
  ¿Para qué? Formalizar el retiro de artículos que ya no se comercializan.
  ¿Impacto? Evita que productos descontinuados sigan apareciendo disponibles para la venta.
-->
