<!--
  ¿Qué? Historia de usuario que describe el respaldo automático de la información del sistema.
  ¿Para qué? Formalizar la generación periódica de copias de seguridad de la base de datos.
  ¿Impacto? Protege al negocio frente a pérdida de información por fallos técnicos.
-->
...
| **RF asociados** | N/A — ver RNF-010 (Respaldo y Recuperación ante Desastres)|
