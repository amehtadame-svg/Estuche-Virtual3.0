<!--
  ¿Qué? Requisito funcional que describe la consulta del historial de compras del cliente.
  ¿Para qué? Definir el alcance de la información que un cliente puede consultar sobre sus pedidos.
  ¿Impacto? Favorece la confianza y la recompra dentro de la plataforma.
-->
