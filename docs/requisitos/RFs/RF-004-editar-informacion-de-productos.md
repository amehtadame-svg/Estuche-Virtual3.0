<!--
  ¿Qué? Requisito funcional que describe la edición de información de productos existentes.
  ¿Para qué? Definir quién puede modificar un producto y qué validaciones aplican.
  ¿Impacto? Mantiene el catálogo actualizado y evita inconsistencias comerciales.
-->

# RF-004 — Editar Información de Productos

**Historia de usuario relacionada**: HU-021
