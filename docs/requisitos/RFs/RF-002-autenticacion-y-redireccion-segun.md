<!--
  ¿Qué? Requisito funcional que describe la autenticación y redirección de usuarios según su rol.
  ¿Para qué? Definir cómo el sistema valida credenciales y dirige a cada usuario a su panel correspondiente.
  ¿Impacto? Protege las funcionalidades de cada rol y evita accesos cruzados indebidos.
-->
