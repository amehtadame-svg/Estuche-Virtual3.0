<!--
  ¿Qué? Requisito funcional que describe el alta de nuevos productos por parte de proveedores.
  ¿Para qué? Definir el flujo de aprobación de productos antes de su publicación en el catálogo.
  ¿Impacto? Garantiza que el administrador controle la calidad de lo que se publica en la tienda.
-->
